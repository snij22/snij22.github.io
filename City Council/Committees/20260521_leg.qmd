...
2. Change Board of Education to School Board. This affects the following charter sections: 
    - C-13
    - C-14

3. Reduce the gendered language in the charter (e.g. councilmen to councilor) as we have multiple women serving on the council. This affects the following sections: 
    - C-8
    - C-9
    - C-15
    - C-24 
